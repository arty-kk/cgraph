...
const LEGACY_LABELS_STORAGE_KEY = 'cs.graph.labels'
const LEGACY_SPOTLIGHT_STORAGE_KEY = 'cs.graph.spotlight'
...
function pidKey(base: string, pid: number | null): string {
  const n = Number(pid)
